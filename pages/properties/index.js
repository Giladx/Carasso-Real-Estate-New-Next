...
import propertiesPageInitialPropsE0ff0Resource from '../../resources/properties-page-initial-props-e0ff0'
...
export async function getStaticProps(context) {
  try {
    const response = await propertiesPageInitialPropsE0ff0Resource({
      ...context?.params,
    })
    if (!response) {
      return {
