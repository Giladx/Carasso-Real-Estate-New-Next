...
import authorsPageInitialPropsTq8Resource from '../../../resources/authors-page-initial-props-tq_-8'
import authorsPageInitialPathsTqXaResource from '../../../resources/authors-page-initial-paths-tq_xa'
...
export async function getStaticProps(context) {
  try {
    const response = await authorsPageInitialPropsTq8Resource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await authorsPageInitialPathsTqXaResource({})
