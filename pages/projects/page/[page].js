...
import projectsPageInitialPropsTqTrResource from '../../../resources/projects-page-initial-props-tq_tr'
import projectsPageInitialPathsTqSwResource from '../../../resources/projects-page-initial-paths-tq_sw'
...
export async function getStaticProps(context) {
  try {
    const response = await projectsPageInitialPropsTqTrResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await projectsPageInitialPathsTqSwResource({})
