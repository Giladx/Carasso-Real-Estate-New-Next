...
import projectsPageInitialPropsTqHMResource from '../../resources/projects-page-initial-props-tq_h-m'
...
export async function getStaticProps(context) {
  try {
    const response = await projectsPageInitialPropsTqHMResource({
      ...context?.params,
    })
    if (!response) {
      return {
