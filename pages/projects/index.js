...
import projectsPageInitialPropsTqBHResource from '../../resources/projects-page-initial-props-tq_b-h'
...
export async function getStaticProps(context) {
  try {
    const response = await projectsPageInitialPropsTqBHResource({
      ...context?.params,
    })
    if (!response) {
      return {
