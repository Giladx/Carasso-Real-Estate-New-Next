...
import tabsPageInitialPathsTqDcResource from '../../../resources/tabs-page-initial-paths-tq_dc'
import tabsPageInitialPropsTqSiResource from '../../../resources/tabs-page-initial-props-tq_si'
...
export async function getStaticPaths() {
  try {
    const response = await tabsPageInitialPathsTqDcResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await tabsPageInitialPropsTqSiResource({
      ...context?.params,
