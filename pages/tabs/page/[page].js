...
import tabsPageInitialPathsTqYpResource from '../../../resources/tabs-page-initial-paths-tq_yp'
import tabsPageInitialPropsTqDLResource from '../../../resources/tabs-page-initial-props-tq_d-l'
...
export async function getStaticPaths() {
  try {
    const response = await tabsPageInitialPathsTqYpResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await tabsPageInitialPropsTqDLResource({
      ...context?.params,
