...
import tabsPageInitialPathsTq9iResource from '../../../resources/tabs-page-initial-paths-tq_9i'
import tabsPageInitialPropsTqFtResource from '../../../resources/tabs-page-initial-props-tq_ft'
...
export async function getStaticPaths() {
  try {
    const response = await tabsPageInitialPathsTq9iResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await tabsPageInitialPropsTqFtResource({
      ...context?.params,
