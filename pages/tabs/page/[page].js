...
import tabsPageInitialPathsTq5pResource from '../../../resources/tabs-page-initial-paths-tq_5p'
import tabsPageInitialPropsTq9yResource from '../../../resources/tabs-page-initial-props-tq_9y'
...
export async function getStaticPaths() {
  try {
    const response = await tabsPageInitialPathsTq5pResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await tabsPageInitialPropsTq9yResource({
      ...context?.params,
