...
import buildingsPageInitialPropsTqBoResource from '../../resources/buildings-page-initial-props-tq_bo'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqBoResource({
      ...context?.params,
    })
    if (!response) {
      return {
