...
import buildingsPageInitialPropsTq3fResource from '../../resources/buildings-page-initial-props-tq_3f'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTq3fResource({
      ...context?.params,
    })
    if (!response) {
      return {
