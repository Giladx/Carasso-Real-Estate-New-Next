...
import buildingsPageInitialPropsTqKHResource from '../../resources/buildings-page-initial-props-tq_k-h'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqKHResource({
      ...context?.params,
    })
    if (!response) {
      return {
