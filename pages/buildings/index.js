...
import buildingsPageInitialPropsTqJResource from '../../resources/buildings-page-initial-props-tq_j_'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqJResource({
      ...context?.params,
    })
    if (!response) {
      return {
