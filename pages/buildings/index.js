...
import buildingsPageInitialPropsTqJbResource from '../../resources/buildings-page-initial-props-tq_jb'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqJbResource({
      ...context?.params,
    })
    if (!response) {
      return {
