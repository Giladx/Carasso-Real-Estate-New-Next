...
import buildingsPageInitialPropsTqUeResource from '../../resources/buildings-page-initial-props-tq_ue'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqUeResource({
      ...context?.params,
    })
    if (!response) {
      return {
