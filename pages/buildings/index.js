...
import buildingsPageInitialPropsTq7tResource from '../../resources/buildings-page-initial-props-tq_7t'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTq7tResource({
      ...context?.params,
    })
    if (!response) {
      return {
