...
import buildingsPageInitialPropsTqOResource from '../../resources/buildings-page-initial-props-tq_-o'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqOResource({
      ...context?.params,
    })
    if (!response) {
      return {
