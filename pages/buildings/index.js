...
import buildingsPageInitialPropsTqSfResource from '../../resources/buildings-page-initial-props-tq_sf'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqSfResource({
      ...context?.params,
    })
    if (!response) {
      return {
