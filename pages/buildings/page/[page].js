...
import buildingsPageInitialPathsTqPsResource from '../../../resources/buildings-page-initial-paths-tq_ps'
import buildingsPageInitialPropsTq8gResource from '../../../resources/buildings-page-initial-props-tq_8g'
...
export async function getStaticPaths() {
  try {
    const response = await buildingsPageInitialPathsTqPsResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTq8gResource({
      ...context?.params,
