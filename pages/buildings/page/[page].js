...
import buildingsPageInitialPropsTqYAResource from '../../../resources/buildings-page-initial-props-tq_y-a'
import buildingsPageInitialPathsTq5nResource from '../../../resources/buildings-page-initial-paths-tq_5n'
...
export async function getStaticProps(context) {
  try {
    const response = await buildingsPageInitialPropsTqYAResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await buildingsPageInitialPathsTq5nResource({})
