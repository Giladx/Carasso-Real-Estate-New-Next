...
import apartmentsPageInitialPropsTqZyResource from '../../resources/apartments-page-initial-props-tq_zy'
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTqZyResource({
      ...context?.params,
    })
    if (!response) {
      return {
