...
import apartmentsPageInitialPropsTqIaResource from '../../resources/apartments-page-initial-props-tq_ia'
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTqIaResource({
      ...context?.params,
    })
    if (!response) {
      return {
