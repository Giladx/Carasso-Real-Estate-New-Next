...
import apartmentsPageInitialPropsTqI2Resource from '../../resources/apartments-page-initial-props-tq_i2'
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTqI2Resource({
      ...context?.params,
    })
    if (!response) {
      return {
