...
import apartmentsPageInitialPropsTqAyResource from '../../resources/apartments-page-initial-props-tq_ay'
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTqAyResource({
      ...context?.params,
    })
    if (!response) {
      return {
