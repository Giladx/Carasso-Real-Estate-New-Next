...
import apartmentsPageInitialPropsTqE9Resource from '../../resources/apartments-page-initial-props-tq_e9'
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTqE9Resource({
      ...context?.params,
    })
    if (!response) {
      return {
