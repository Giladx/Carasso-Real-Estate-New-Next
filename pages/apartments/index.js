...
import apartmentsPageInitialPropsTq7qResource from '../../resources/apartments-page-initial-props-tq_7q'
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTq7qResource({
      ...context?.params,
    })
    if (!response) {
      return {
