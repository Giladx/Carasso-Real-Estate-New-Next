...
import apartmentsPageInitialPathsTqOResource from '../../../resources/apartments-page-initial-paths-tq_o-'
import apartmentsPageInitialPropsTqWoResource from '../../../resources/apartments-page-initial-props-tq_wo'
...
export async function getStaticPaths() {
  try {
    const response = await apartmentsPageInitialPathsTqOResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTqWoResource({
      ...context?.params,
