...
import apartmentsPageInitialPathsTqReResource from '../../../resources/apartments-page-initial-paths-tq_re'
import apartmentsPageInitialPropsTqTjResource from '../../../resources/apartments-page-initial-props-tq_tj'
...
export async function getStaticPaths() {
  try {
    const response = await apartmentsPageInitialPathsTqReResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTqTjResource({
      ...context?.params,
