...
import apartmentsPageInitialPathsTqWnResource from '../../../resources/apartments-page-initial-paths-tq_wn'
import apartmentsPageInitialPropsTqHbResource from '../../../resources/apartments-page-initial-props-tq_hb'
...
export async function getStaticPaths() {
  try {
    const response = await apartmentsPageInitialPathsTqWnResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTqHbResource({
      ...context?.params,
