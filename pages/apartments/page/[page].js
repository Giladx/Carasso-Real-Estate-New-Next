...
import apartmentsPageInitialPropsTq0lResource from '../../../resources/apartments-page-initial-props-tq_0l'
import apartmentsPageInitialPathsTqXpResource from '../../../resources/apartments-page-initial-paths-tq_xp'
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTq0lResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await apartmentsPageInitialPathsTqXpResource({})
