...
import apartmentsPageInitialPathsTq59Resource from '../../../resources/apartments-page-initial-paths-tq_59'
import apartmentsPageInitialPropsTqYwResource from '../../../resources/apartments-page-initial-props-tq_yw'
...
export async function getStaticPaths() {
  try {
    const response = await apartmentsPageInitialPathsTq59Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await apartmentsPageInitialPropsTqYwResource({
      ...context?.params,
