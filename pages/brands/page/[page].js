...
import brandsPageInitialPathsTqBvResource from '../../../resources/brands-page-initial-paths-tq_bv'
import brandsPageInitialPropsTqMnResource from '../../../resources/brands-page-initial-props-tq_mn'
...
export async function getStaticPaths() {
  try {
    const response = await brandsPageInitialPathsTqBvResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await brandsPageInitialPropsTqMnResource({
      ...context?.params,
