...
import brandsPageInitialPropsTqWDResource from '../../../resources/brands-page-initial-props-tq_w-d'
import brandsPageInitialPathsTqKUResource from '../../../resources/brands-page-initial-paths-tq_k-u'
...
export async function getStaticProps(context) {
  try {
    const response = await brandsPageInitialPropsTqWDResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await brandsPageInitialPathsTqKUResource({})
