...
import brandsPageInitialPathsTq1gResource from '../../../resources/brands-page-initial-paths-tq_1g'
import brandsPageInitialPropsTqWsResource from '../../../resources/brands-page-initial-props-tq_ws'
...
export async function getStaticPaths() {
  try {
    const response = await brandsPageInitialPathsTq1gResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await brandsPageInitialPropsTqWsResource({
      ...context?.params,
