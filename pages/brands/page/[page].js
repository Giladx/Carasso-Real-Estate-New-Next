...
import brandsPageInitialPaths509e7Resource from '../../../resources/brands-page-initial-paths-509e7'
import brandsPageInitialProps8e4acResource from '../../../resources/brands-page-initial-props-8e4ac'
...
export async function getStaticPaths() {
  try {
    const response = await brandsPageInitialPaths509e7Resource({})
...
export async function getStaticProps(context) {
  try {
    const response = await brandsPageInitialProps8e4acResource({
      ...context?.params,
