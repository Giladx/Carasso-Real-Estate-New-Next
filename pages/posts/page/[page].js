...
import postsPageInitialPropsTqHrResource from '../../../resources/posts-page-initial-props-tq_hr'
import postsPageInitialPathsTqZeResource from '../../../resources/posts-page-initial-paths-tq_ze'
...
export async function getStaticProps(context) {
  try {
    const response = await postsPageInitialPropsTqHrResource({
      ...context?.params,
...
export async function getStaticPaths() {
  try {
    const response = await postsPageInitialPathsTqZeResource({})
