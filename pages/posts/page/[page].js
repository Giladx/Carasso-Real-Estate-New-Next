...
import postsPageInitialPathsTqFyResource from '../../../resources/posts-page-initial-paths-tq_fy'
import postsPageInitialPropsTqZLResource from '../../../resources/posts-page-initial-props-tq_z-l'
...
export async function getStaticProps(context) {
  try {
    const response = await postsPageInitialPropsTqZLResource({
      ...context?.params,
