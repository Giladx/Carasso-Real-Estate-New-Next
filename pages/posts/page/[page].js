...
import postsPageInitialPathsTqZtResource from '../../../resources/posts-page-initial-paths-tq_zt'
import postsPageInitialPropsTqLwResource from '../../../resources/posts-page-initial-props-tq_lw'
...
export async function getStaticPaths() {
  try {
    const response = await postsPageInitialPathsTqZtResource({})
...
export async function getStaticProps(context) {
  try {
    const response = await postsPageInitialPropsTqLwResource({
      ...context?.params,
