...
import tagsPageInitialPaths4a1c8Resource from '../../resources/tags-page-initial-paths-4a1c8'
import tagsPageInitialProps7eaebResource from '../../resources/tags-page-initial-props-7eaeb'
...
export async function getStaticPaths() {
  try {
    const response = await tagsPageInitialPaths4a1c8Resource({})
    return {
...
export async function getStaticProps(context) {
  try {
    const response = await tagsPageInitialProps7eaebResource({
      ...context?.params,
    })
    if (!response?.data?.[0]) {
      return {
